-- Rollback Migration 001: Schema Enhancements (FIXED)
-- This script reverses all changes made in 001_schema_enhancements_fixed.sql
...
-- Note: This recreates the original constraint that may have used IFNULL
-- If the original didn't work, you'll need to adjust this based on your original schema
ALTER TABLE dictionary_event
  ADD UNIQUE KEY uniq_event (diagnosis, icd10, source);
